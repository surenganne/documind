...
export function Login() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-[var(--dm-surface)]">
      <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <h1
          className="mb-1 text-2xl font-semibold text-[var(--dm-primary)]"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium text-slate-600" htmlFor="password">Password</label>
            <input
              id="password"
              type="password"
              required
          ...
          <button
            type="submit"
            disabled={loading}
            className="rounded-lg bg-[var(--dm-primary)] py-2 text-sm font-medium text-white hover:bg-[var(--dm-primary-dark)] disabled:opacity-50 transition-colors"
          >
